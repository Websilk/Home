...
namespace Websilk.Pipeline
{
    public class PageRequest
    {
        ...
        public PageRequest(Server server, HttpContext context)
        {
            ...
            S.javascript.Add("init", "S.init(" + (S.User.useAjax ? "true" : "false") + "," + page.pageId + "," + page.pageType + ",'" + page.pagePathName + "','" + page.pageTitle + "','" + page.PageTitleForBrowserTab + "'," + page.websiteId + ",'" + page.websiteTitle + "');");
